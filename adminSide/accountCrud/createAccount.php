...
<div class="wrapper">
    ...
    <form method="POST" action="success_create_staff_Account.php" class="ht-600 w-50">
        ...
        <div class="form-group">
            ...
            <input type="text" name="phone_number" placeholder="+91 90008007001" class="form-control <?php echo !$phone_numberErr ?: 'is-invalid'; ?>" id="phone_number" required value="<?php echo $phone_number; ?>"><br>
            <div id="validationServerFeedback" class="invalid-feedback">
